...
export default function ContactModal({ open, onClose }: ContactModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("ContactModal submitted:", form);
    onClose();
  };
      ...
      >
        ...
        >
          ...
          <div className="contact-modal-image w-[45%] shrink-0 relative overflow-hidden">
            <img
              src="/images/shakinh-hands.webp"
              alt="Assessor Marco Investimentos"
              className="absolute inset-0 w-full h-full object-cover"
            />
            {/* Gradient overlay para fundir com o form */}
            <div
              className="absolute inset-0"
              style={{
                background:
                  "linear-gradient(to right, transparent 60%, rgba(10,8,6,0.85) 100%)",
              }}
            />
            {/* Bottom overlay */}
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, rgba(10,8,6,0.6) 0%, transparent 50%)",
              }}
            />
          </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <label className="flex items-start gap-3 cursor-pointer group mt-1">
                  <div className="relative mt-0.5 shrink-0">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("comunicacoes", e.target.checked)
                      }
                      className="sr-only"
                    />
                    <div
                      ...
                      style={{
                        background: form.comunicacoes
                          ? "#C2A161"
                          : "rgba(255,255,255,0.08)",
                        borderColor: form.comunicacoes
                          ? "#C2A161"
                ...
                <button
                  ...
                  style={{
                    ...
                    color: "white",
                    boxShadow: "0 4px 20px rgba(194,161,97,0.35)",
                  }}
                >
                  Enviar mensagem
                </button>
